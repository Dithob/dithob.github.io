...
- Profile README source and sync guide: `docs/profile-maintenance.md`
- Default preview URL: `https://dithob.github.io`

Before publishing a custom domain, review the resume content and replace `public/CNAME.example` with the verified domain, then rename it to `public/CNAME`.
